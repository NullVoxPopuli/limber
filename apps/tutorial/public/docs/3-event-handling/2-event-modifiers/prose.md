...
- `capture` -- when true, events of this type are dispatched to the registered listener first. Only afterwards are they dispatched to any `EventTarget` beneath it in the DOM tree.
