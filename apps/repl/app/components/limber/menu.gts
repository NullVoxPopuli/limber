...
const Button: TOC<{
  ...
  <@content.Item
    class="block w-full bg-transparent px-4 py-2 text-left text-black select-none ring-inset hover:bg-gray-100 focus:ring-4 focus:outline-none"
    tabindex="0"
...
const DefaultTrigger: TOC<{
  ...
  <@menu.Trigger
    class="-my-1 rounded border bg-white px-2 py-1 text-left text-black ring-ember-brand drop-shadow-md transition duration-150 ease-in-out hover:drop-shadow-xl focus:ring-4 focus:outline-none focus-visible:outline-none sm:text-sm"
    ...attributes
  >
    {{yield @menu}}
  </@menu.Trigger>
