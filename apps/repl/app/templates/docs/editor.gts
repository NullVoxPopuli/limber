import highlighted from '#app/utils/highlighting/modifier.ts';
...
<template>
  ...
  <div class="main-content">
    ...
    <article>
      <header aria-label="Supported: Ember GJS">
    ...
    <article>
      <header aria-label="Supported: Mermaid">
    ...
    <article>
      <header aria-label="Supported: Svelte">
    ...
    <article>
      <header aria-label="Supported: Vanilla JS">
  ...
  element.textContent = 'hello there';
    ...
    <article>
      <header aria-label="Supported: Vue">
    ...
    <article>
      <header aria-label="Supported: Ember HBS">
    ...
    <article>
      <header aria-label="Supported: Glimdown">
